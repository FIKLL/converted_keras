...
async def klasifikasi(ctx):
    ...
    # kode untuk AI
    reponse = requests.get(list(data)[-1])
    with open("image.jpg", "wb") as f:
        f.write(response.content)
    result = pendeteki("image.jpg")

    await ctx.send(result)

bot.run("MTE1NzI2ODQ2ODgxOTgyNDc0MA.Gkj2x4.zWEjlBiF4yhsOhNLC1WNdL3w0vkPhr9mBmsoDs")